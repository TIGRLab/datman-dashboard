...
def upgrade():
    ...
    sa.Column('dashboard_admin', sa.Boolean(), nullable=True),
    ...
    sa.Column('uses_redcap', sa.Boolean(), nullable=True),
    sa.Column('code', sa.String(length=32), nullable=True),
    sa.ForeignKeyConstraint(['site'], ['sites.name'], ),
    sa.ForeignKeyConstraint(['study'], ['studies.id'], ),
    sa.PrimaryKeyConstraint('study', 'site'),
    ...
    sa.Column('kimel_contact', sa.Boolean(), nullable=True),
    sa.Column('study_ra', sa.Boolean(), nullable=True),
    sa.Column('does_qc', sa.Boolean(), nullable=True),
    ...
    sa.Column('last_qc_generated', sa.Integer(), nullable=False),
    ...
    sa.PrimaryKeyConstraint('study', 'site', 'code')
    )
    ...
    sa.Column('signed_off', sa.Boolean(), nullable=True),
    ...
    sa.Column('timepoint', sa.String(length=64), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('comment_timestamp', sa.DateTime(timezone=True), nullable=False),
